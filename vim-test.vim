" To be copied in .vim/plugged/vim-test/autoload/test.vim
" Javascript tests with Jest and a test suite in a sub-directory (with
" package.json) is not working so trick row 164
...
let g:root_markers = ['package.json']
